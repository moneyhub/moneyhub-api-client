...
* Husky pre-commit runs unit tests; pre-push runs serial multi-version unit smoke tests (Node 20/22/24/26 when installed via nvm), then integration once, then CaaS.
